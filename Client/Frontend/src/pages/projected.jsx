...
export default function ProjectedValueDashboard() {
  ...
  const avgProjectedValue = totalProperties
    ? (data.reduce((sum, item) => sum + item.projected_value_in_5_years, 0) / totalProperties).toFixed(2)
    : 0;
  ...
  const sortedData = [...data].sort((a, b) => b.projected_value_in_5_years - a.projected_value_in_5_years);
            ...
            <div className="p-4">
              <ResponsiveContainer width="100%" height={360}>
                <BarChart data={sortedData} margin={{ top: 20, right: 30, left: 20, bottom: 60 }} barSize={40}>
                  ...
                  <Bar 
                    dataKey="projected_value_in_5_years" 
                ...
                <tbody>
                  {sortedData.map((item, index) => (
                    ...
                    >
                      ...
                      <td className="p-3 text-right">₹{item.current_value.toLocaleString()}</td>
                      <td className="p-3 text-right">{item.growth_rate.toFixed(2)}%</td>
                      <td className="p-3 font-medium text-indigo-700 text-right">
                        ₹{item.projected_value_in_5_years.toLocaleString(undefined, { maximumFractionDigits: 2 })}
                      </td>
                    </tr>
                  ))}
                </tbody>
